...
class HolidaysSourceTest {
    ...
    fun `should return list of all holidays without duplicates`() {
        ...
        assertEquals(LocalDate.of(2019, Month.JANUARY, 1), holiday1.startDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
        assertEquals(LocalDate.of(2019, Month.JANUARY, 1), holiday1.endDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
        ...
        assertEquals(LocalDate.of(2019, Month.MARCH, 8), holiday2.startDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
        assertEquals(LocalDate.of(2019, Month.MARCH, 8), holiday2.endDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
        ...
        assertEquals(LocalDate.of(2019, Month.MAY, 30), holiday3.startDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
        assertEquals(LocalDate.of(2019, Month.MAY, 30), holiday3.endDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate())
